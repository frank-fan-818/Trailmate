...
import type { CompanionProfile, UserProfile, CompanionFilters, MatchResult, TeamRequest } from './src/types/index'
export type { CompanionProfile, UserProfile, CompanionFilters, MatchResult, TeamRequest } from './src/types/index'
